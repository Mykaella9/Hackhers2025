...
// Entitlements
  ...
  // Users
  const users = [
    { id: 1,  firstName: 'Bon',       lastName: 'Jovi',      computerId: 10001, managerId: 555 },
    { id: 2,  firstName: 'Susan B.',  lastName: 'Anthony',   computerId: 10002, managerId: 555 },
    { id: 3,  firstName: 'Michael',   lastName: 'Jackson',   computerId: 10003, managerId: 555 },
    { id: 4,  firstName: 'Maya',      lastName: 'Angelou',   computerId: 10004, managerId: 555 },
    { id: 5,  firstName: 'Brad',      lastName: 'Pitt',      computerId: 10005, managerId: 555 },
    { id: 6,  firstName: 'Simone',    lastName: 'Biles',     computerId: 10006, managerId: 555 },
    { id: 7,  firstName: 'Kobe',      lastName: 'Bryant',    computerId: 10007, managerId: 555 },
    { id: 8,  firstName: 'Amelia',    lastName: 'Airhart',   computerId: 10008, managerId: 555 },
    { id: 9,  firstName: 'Jane',      lastName: 'Austen',    computerId: 10009, managerId: 555 },
    { id: 10, firstName: 'Harry',     lastName: 'Styles',    computerId: 10010, managerId: 555 },
    { id: 11, firstName: 'Taylor',    lastName: 'Swift',     computerId: 10011, managerId: 555 },
    { id: 12, firstName: 'Serena',    lastName: 'Williams',  computerId: 10012, managerId: 555 },
    { id: 13, firstName: 'Steph',     lastName: 'Curry',     computerId: 10013, managerId: 555 },
  ...
  const teamEntitlementMap: Record<number, number[]> = {
    10: [1, 2, 3, 12], // CyberTeam
    20: [4, 5, 6, 10, 11, 13], // DataScientists
    30:[4, 7, 10, 11, 12, 13, 14, 15], // MLOps
    40: [4, 5, 6, 10, 11, 12], // Elevates
    50: [1, 2, 3, 6, 7, 8, 9, 10, 11], // SeniorDevelopers
    60: [4, 5, 6, 7, 9] // BusinessAnalysts
  }
  ...
  for (const [mgrIdStr, mgrUsersRaw] of Object.entries(usersByManager)) {
    ...
    for (const u of mgrUsers) {
      ...
      const userEnts = circularPick(entList, u.id * 2, 2).map(e => ({ id: e.id }))
